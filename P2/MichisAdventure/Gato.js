...
class Gato extends THREE.Object3D {
  ...
  update(tiempo) {
    ...
    switch(this.label){
      case 'run':
        this.anim.animacion(0, 4, tiempo);
        
      break;
      case 'die':
        if (this.contador <= 5) {
          this.anim.animacion(1, 5, tiempo);
          this.contador++;
          if (this.contador == 5) {
            this.label = 'run';
            this.anim.restart();
      ...
      case 'hurt':
        if (this.contador <= 5) {
          this.anim.animacion(2, 5, tiempo);
          this.contador++;
          if (this.contador == 5) {
            this.label = 'run';
            this.anim.restart();
      ...
      case 'jump':
        if (this.contador < 8) {
          this.anim.animacion(3, 8, tiempo);
      ...
      break;
      case 'idle':
        this.anim.animacion(4, 13, tiempo);
      break;
